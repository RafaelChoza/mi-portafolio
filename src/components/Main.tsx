        ...
        <section id="projects" className="mb-12">
          ...
          <ul className="mt-6 space-y-6">
            {projects.map((project, index) => (
              <li
                key={index}
                className="bg-gray-800 h-fit p-6 rounded-lg shadow-lg hover:shadow-2xl transition-transform duration-500 ease-out transform hover:scale-105 animate-scale-in"
              >
                <h3 className="text-xl md:text-2xl font-bold">{project.name}</h3>
                <img src={project.image} className="object-cover w-1/3 h-full float-right" alt="" />
